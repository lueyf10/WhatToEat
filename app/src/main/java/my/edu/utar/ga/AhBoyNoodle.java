...
public class AhBoyNoodle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ah_boy_noodle);
        ...
        String name = "Ah Boy Noodle";
        String category = "Local";
        double rating = 4.1;
        String mondayHours = "11am-3.15pm,6pm-8.15pm";
        String tuesdayHours = "11am-3.15pm,6pm-8.15pm";
        String wednesdayHours = "11am-3.15pm,6pm-8.15pm";
        String thursdayHours = "11am-3.15pm,6pm-8.15pm";
        String fridayHours = "11am-3.15pm,6pm-8.15pm";
        String saturdayHours = "11am-3.15pm,6pm-8.15pm";
        String sundayHours = "11am-3.15pm,6pm-8.15pm";
        String budget = "$$";
        String description = "Chinese noodle restaurant";
