...
public class Buddies extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = "Buddies Cafe And Bar";
        String category = "Cafe,";
        double rating = 4.3;
        String mondayHours = "11.30am-9.15pm";
        String tuesdayHours = "11.30am-9.15pm";
        String wednesdayHours = "11.30am-9.15pm";
        String thursdayHours = "11.30am-9.15pm";
        String fridayHours = "11.30am-9.15pm";
        String saturdayHours = "11.30am-9.15pm";
        String sundayHours = "11.30am-9.15pm";
        String budget = "$$";
        String description = "cafe that famous with coffee and western food such as spaghetti and chicken chop.";
