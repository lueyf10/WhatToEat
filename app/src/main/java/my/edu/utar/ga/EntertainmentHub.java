...
public class EntertainmentHub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = "Entertainment Hub";
        String category = "Western restaurant";
        double rating = 4.2;
        String mondayHours = "11am-2am";
        String tuesdayHours = "11am-2am";
        String wednesdayHours = "11am-2am";
        String thursdayHours = "11am-2am";
        String fridayHours = "11am-2am";
        String saturdayHours = "11am-2am";
        String sundayHours = "11am-2am";
        String budget = "$$";
        String description = " western restaurant that famous with steaks and beer.";
