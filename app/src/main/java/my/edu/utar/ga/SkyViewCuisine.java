...
public class SkyViewCuisine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sky_view_cuisine);
        ...
        String name = "SkyView Cuisine & Hotpot";
        String category = "Steamboat restaurant";
        double rating = 3.7;
        String mondayHours = "12–10:30pm";
        String tuesdayHours = "12–10:30pm";
        String wednesdayHours = "12–10:30pm";
        String thursdayHours = "12–10:30pm";
        String fridayHours = "12–10:30pm";
        String saturdayHours = "12–10:30pm";
        String sundayHours = "12–10:30pm";
        String budget = "$$";
        String description = "steamboat buffet with fresh seafood and meat.";
