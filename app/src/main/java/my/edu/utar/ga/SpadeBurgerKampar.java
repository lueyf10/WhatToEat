...
public class SpadeBurgerKampar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = "Spade's Burger Kampar";
        String category = "fastfood";
        double rating = 3.9;
        String mondayHours = "11.30am-10.00pm";
        String tuesdayHours = "11.30am-10.00pm";
        String wednesdayHours = "11.30am-10.00pm";
        String thursdayHours = "11.30am-10.00pm";
        String fridayHours = "11.30am-10.00pm";
        String saturdayHours = "11.30am-10.00pm";
        String sundayHours = "11.30am-10.00pm";
        String budget = "$$";
        String description = "Burger joint.";
