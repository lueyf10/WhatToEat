...
public class Subway extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = "Subway Kampar";
        String category = "fastfood,";
        double rating = 3.9;
        String mondayHours = "7am-10.30pm";
        String tuesdayHours = "7am-10.30pm";
        String wednesdayHours = "7am-10.30pm";
        String thursdayHours = "7am-10.30pm";
        String fridayHours = "7am-10.30pm";
        String saturdayHours = "7am-10.30pm";
        String sundayHours = "7am-10.30pm";
        String budget = "$$";
        String description = "Casual counter-serve chain for build-your-own sandwiches & salads, with health-conscious options.";
