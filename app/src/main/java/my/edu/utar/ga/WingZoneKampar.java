...
public class WingZoneKampar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wing_zone_kampar);
        ...
        String name = "Wing Zone Kampar";
        String category = "fastfood";
        double rating = 4.2;
        String mondayHours = "10.30am-10.30pm";
        String tuesdayHours = "10.30am-10.30pm";
        String wednesdayHours = "10.30am-10.30pm";
        String thursdayHours = "10.30am-10.30pm";
        String fridayHours = "10.30am-10.30pm";
        String saturdayHours = "10.30am-10.30pm";
        String sundayHours = "10.30am-10.30pm";
        String budget = "$$";
        String description = "Casual counter-serve chain offering wings with an array of signature sauces & other fast fare.";
