...
public class WoodyHouse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_woody_house);
        ...
        String name = "Woody House";
        String category = "Japanese restaurant,";
        double rating = 3.9;
        String mondayHours = "11.30am-9.30pm";
        String tuesdayHours = "11.30am-9.30pm";
        String wednesdayHours = "11.30am-9.30pm";
        String thursdayHours = "11.30am-9.30pm";
        String fridayHours = "11.30am-9.30pm";
        String saturdayHours = "11.30am-9.30pm";
        String sundayHours = "11.30am-9.30pm";
        String budget = "$$$";
        String description = "japanese and korean traditional food.";
